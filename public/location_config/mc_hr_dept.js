...
ses_location_config // <- don't change this variable name!
  ...
  .mc_hr_dept = { // <- make sure you change this one to the same name as the location name!!!
    ...
    fieldsDisplayChart: [
      ...
      {
        label: '1st Floor HVAC Vent (F)',
        fieldsData: ['HVAC_vent_1st_floor_Degrees_F'],
        checked: true,
        fun: function(data) {
          'use strict';

          return data.HVAC_vent_1st_floor_Degrees_F;
        }
      },
      {
        label: '1st Floor Office (F)',
        fieldsData: ['1st_floor_office_Degrees_F'],
        checked: true,
        fun: function(data) {
          'use strict';

          return data['1st_floor_office_Degrees_F'];
        }
      },
      {
