...
ses_location_config // <- don't change this variable name!
  ...
  .mc_fleet_maintenance = { // <- make sure you change this one to the same name as the location name!!!
    ...
    fieldsDisplayChart: [
      ...
      {
        label: 'Office (F)',
        fieldsData: ['Office_Degrees_F'],
        checked: true,
        fun: function(data) {
          'use strict';

          return data.Office_Degrees_F;
        }
      },
      {
        label: 'Outdoor (F)',
        fieldsData: ['Outdoor_Degrees_F'],
        checked: true,
        fun: function(data) {
          'use strict';

          return data.Outdoor_Degrees_F;
        }
      },
      {
